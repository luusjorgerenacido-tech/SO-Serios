  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      >
        ...
        <h2 className="text-3xl font-bold text-gray-800 mb-4">Juego de Simulación de Sistemas Operativos</h2>
        ...
        <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center mb-6">
          <span className="text-gray-500 text-lg">Simulación de SO - ¡Gestiona procesos y recursos!</span>
        </div>
        <Link 
          to="/" 
